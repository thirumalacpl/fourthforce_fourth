...
$(document).off('click', '#dashcooiweraabbqowez').on('click', '#dashcooiweraabbqowez', function() {
  
  $.mobile.changePage($('#dashboard_sh'), { transition: "none", changeHash: true, reverse: false });
return false;
});

 $(document).off('click', '#newsheraabbqowez').on('click', '#newsheraabbqowez', function() {
...
return false;
 ...
 $(document).off('click', '#newlistinbbqowez').on('click', '#newlistinbbqowez', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
  ...
  $(document).off('click', '#shapprovedinuoaabbqowez').on('click', '#shapprovedinuoaabbqowez', function() {
  //sessionStorage.getItem.clear;
...
return false;
 ...
 $(document).off('click', '#shapprovedzoneaabbqowez').on('click', '#shapprovedzoneaabbqowez', function() {
  //sessionStorage.getItem.clear;
...
return false;
      ...
      $(document).off('click', '#completedshiooaabbqowez').on('click', '#completedshiooaabbqowez', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
                  ...
                  $(document).off('click', '#rejectieiopaabbqowez').on('click', '#rejectieiopaabbqowez', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
                        ...
                        $(document).off('click', '#verifalyuiaabbqowez').on('click', '#verifalyuiaabbqowez', function() {
  //sessionStorage.getItem.clear;
  //$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
...
return false;
    ...
    $(document).off('click', '#signoutcooieraabbqowez').on('click', '#signoutcooieraabbqowez', function() {
...
$(document).off('click', '#before_new_listrtuioqqyui').on('click', '#before_new_listrtuioqqyui', function() {
//sessionStorage.getItem.clear;
//$.mobile.changePage("index.html", { transition: "none", changeHash: true, reverse: false }); 
$.mobile.changePage($('#sh_Verified_false'), { transition: "none", changeHash: true, reverse: false });
return false;
...
//alert(oneemp);
  $('.ssnewinpwe').append('<li><a href="http://fourthforce.in/verify/slim-fourth/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/slim-fourth/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(oneemp);
  $('.ssnewinpwe').append('<li><a href="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
