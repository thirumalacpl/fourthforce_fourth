...
// /alert(oneemp);
  $('.ssd').append('<li><a href="http://fourthforce.in/verify/slim-fourth/uploads/'+oneemp+'"><img src="http://fourthforce.in/verify/slim-fourth/uploads/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
//alert(one+'oneoooooooooooooooooooooooooo');
     $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/uploads/'+one+'"><img src="http://fourthforce.in/verify/slim-fourth/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/uploads/'+oneo+'"><img src="http://fourthforce.in/verify/slim-fourth/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notveria').append('<img src="http://staging.eimpressive.com/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/uploads/'+oneoo+'"><img src="http://fourthforce.in/verify/slim-fourth/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverid').append('<img src="http://staging.eimpressive.com/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/uploads/'+oneooo+'"><img src="http://fourthforce.in/verify/slim-fourth/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverie').append('<img src="http://staging.eimpressive.com/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/uploads/'+oner+'"><img src="http://fourthforce.in/verify/slim-fourth/uploads/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneemp);
  $('.ssd').append('<li><a href="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+oneemp+'"><img src="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+oneemp+'" style="height: 100%;width:100%" ></a></li>');
...
if ( j == 0){
  ...
  //alert(one+'oneiiiiiiiiiiiiiiiiiiiiiiiiiii');
   $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+one+'"><img src="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//alert(oneo+'two');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+oneo+'"><img src="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notveria').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+oneoo+'"><img src="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverid').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+oneooo+'"><img src="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
...
//$('.document_imag_inproone_notverie').append('<img src="http://staging.eimpressive.com/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
  $('.s1').append('<li><a href="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+oner+'"><img src="http://fourthforce.in/verify/slim-fourth/documents/addressid/'+one+'"  style="height: 300px;width:350px"></a></li>');
